...
const BlogIndex: FC<PageProps<GatsbyTypes.BlogIndexCategoryQuery>> = ({
  data,
  location,
}) => {
...
export const pageQuery = graphql`
  query BlogIndexCategory($limit: Int!, $skip: Int!, $category: String!) {
    ...
    allMarkdownRemark(
      ...
      filter: {
        frontmatter: { isFixed: { nin: true }, category: { eq: $category } }
      }
      limit: $limit
      skip: $skip
    ) {
